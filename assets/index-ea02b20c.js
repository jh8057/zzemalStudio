...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:In,depthTest:!1,depthWrite:!1})}function gc(){return new li({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Ca(),fragmentShader:`
		...
		`,blending:In,depthTest:!1,depthWrite:!1})}function _c(){return new li({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Ca(),fragmentShader:`
...
`].filter(cr).join(`
`)),a=Jo(a),a=Tc(a,t),a=Ac(a,t),o=Jo(o),o=Tc(o,t),o=Ac(o,t),a=Cc(a),o=Cc(o),t.isWebGL2&&t.isRawShaderMaterial!==!0&&(w=`#version 300 es
